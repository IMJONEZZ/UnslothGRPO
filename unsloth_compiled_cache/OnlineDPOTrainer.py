...
from trl.trainer.online_dpo_trainer import (DataLoader, PreTrainedModel, Union, Any, SIMPLE_CHAT_TEMPLATE, generate_model_card, textwrap, os, empty_cache, Optional, jinja2, unwrap_model_for_generation, BaseImageProcessor, EvalPrediction, SamplingParams, warnings, DataCollator, TrainerCallback, disable_dropout_in_model, GenerationConfig, nn, prepare_deepspeed, get_reward, BasePairwiseJudge, is_conversational, IterableDataset, ProcessorMixin, PREFIX_CHECKPOINT_DIR, datasets, seed_worker, F, OnlineDPOConfig, create_reference_model, is_wandb_available, maybe_apply_chat_template, torch, truncate_right, transformers, is_peft_available, Callable, DPODataCollatorWithPadding, wraps, Trainer, np, OptimizerNames, Dataset, PeftModel, version, get_comet_experiment_url, PreTrainedTokenizerBase, FeatureExtractionMixin, apply_chat_template)

class UnslothOnlineDPOTrainer(Trainer):
    r"""
